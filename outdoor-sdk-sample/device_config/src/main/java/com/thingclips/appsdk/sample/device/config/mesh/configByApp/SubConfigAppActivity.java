package com.thingclips.appsdk.sample.device.config.mesh.configByApp;
...
//                        getSubDeviceInfo(bean);
    ...
    private void startActivator() {
        ...
        iThingBlueMeshActivator = ThingHomeSdk.getThingBlueMeshConfig().newSigActivator(thingSigMeshActivatorBuilder);
