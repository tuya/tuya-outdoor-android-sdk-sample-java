package com.thingclips.appsdk.sample.device.config.mesh;
...
import com.thingclips.appsdk.sample.device.config.mesh.configByApp.SubConfigAppActivity;
import com.thingclips.appsdk.sample.device.config.mesh.configByGateway.SubConfigGatewayActivity;
